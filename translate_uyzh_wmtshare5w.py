...
_NC_TRAIN_DATASETS = [[
    ...
    ["raw-train.uy-zh.uy", "raw-train.uy-zh.zh"]
]]

_NC_TEST_DATASETS = [[
    "http://data.actnned.com/ai/machine_learning/dummy.dev.tgz",
    ("raw-dev.uy-zh.uy", "raw-dev.uy-zh.zh")
]]
...
class TranslateUyzhWmtshare5w(translate.TranslateProblem):
    ...
    def source_vocab_name(self):
        return "vocab.uyzh-sub-uy.%d" % self.approx_vocab_size

    @property
    def target_vocab_name(self):
        return "vocab.uyzh-sub-zh.%d" % self.approx_vocab_size
    ...
    def generate_encoded_samples(self, data_dir, tmp_dir, dataset_split):
        ...
        filename_base = "wmt_uyzh_%sk_sub_%s" % (self.approx_vocab_size, tag)
